...
I2 = [I2,S2];
%% Optimization
while Global.NotTermination(arch)
    ...
    if Global.evaluated >= Global.evaluation
        ...
        fileName1 = sprintf('D:\\experiment\\DSDN\\Curve\\PPS_%s_GHD.mat', problem_name);
        fileName2 = sprintf('D:\\experiment\\DSDN\\Curve\\PPS_%s_IGDp.mat', problem_name);
